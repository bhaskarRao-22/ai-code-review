    ...
    return (
        <div className="h-full flex flex-col lg:grid lg:gap-6 lg:grid-cols-2">
            ...
            <section className="flex flex-col h-full rounded-xl lg:rounded-2xl border border-slate-800 bg-slate-900/40 p-3 lg:p-4 mb-4 lg:mb-0">
                ...
                <div className="flex-1 min-h-1/2 flex flex-col">
                    <textarea
                        className="flex-1 min-h-1/2 w-full resize-none rounded-lg lg:rounded-xl border border-slate-800 bg-slate-950 p-3 text-sm text-slate-100 outline-none focus:border-sky-500 disabled:opacity-60"
